...
open class MpvPlayerPlugin(
  private val channelBase: String = "co.sumit.harbor/mpv_player",
  private val audioOnly: Boolean = false
) : FlutterPlugin,
  MethodChannel.MethodCallHandler,
  EventChannel.StreamHandler,
  ActivityAware,
  co.sumit.harbor.shared.PlayerDelegate {
 ...
 */
class MpvAudioPlayerPlugin : MpvPlayerPlugin(channelBase = "co.sumit.harbor/mpv_audio_player", audioOnly = true)
