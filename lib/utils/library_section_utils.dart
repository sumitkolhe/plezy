...
int? librarySectionIdFromJson(Map<String, dynamic>? json) {
  ...
  for (final key in const ['librarySectionKey', 'key', 'hubKey']) {
    final parsed = librarySectionIdFromString(json[key]?.toString());
...
String? librarySectionTitleFromJson(Map<String, dynamic>? json) {
