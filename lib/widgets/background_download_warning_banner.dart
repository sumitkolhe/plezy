      ...
      builder: (context, _) {
        ...
        return Material(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                AppIcon(blocked ? PhosphorIconsFill.batteryWarning : PhosphorIconsFill.info, fill: 1, color: foreground),
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: const AppIcon(PhosphorIconsFill.caretRight, fill: 1, size: 18),
                    ),
                    const SizedBox(width: 8),
              ...
              Align(
                ...
                child: FocusableButton(
                  ...
                  child: TextButton.icon(
                    onPressed: () => _openDontKillMyApp(dialogContext, launcher: externalUrlLauncher),
                    icon: const AppIcon(PhosphorIconsFill.arrowSquareOut, fill: 1, size: 18),
