...
class _LibraryManagementSheetState extends State<_LibraryManagementSheet>
  ...
  Widget build(BuildContext context) {
        ...
        child: PopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: Row(
                children: [
                  const AppIcon(PhosphorIcons.pencilSimple),
                  const SizedBox(width: 12),
                  Text(t.libraries.manageLibraries),
                ],
              ),
              automaticallyImplyLeading: false,
              actions: [IconButton(icon: const AppIcon(PhosphorIcons.x), onPressed: () => Navigator.pop(context))],
            ),
            body: Focus(
    ...
    return Column(
      children: [
        BottomSheetHeader(title: t.libraries.manageLibraries, icon: PhosphorIcons.pencilSimple),
        Flexible(
          child: Focus(
            focusNode: _listFocusNode,
            descendantsAreFocusable: false,
        ...
        leading: Row(
          ...
          children: [
            ReorderableDragStartListener(
              index: index,
              child: AppIcon(
                isMoving ? PhosphorIcons.arrowsDownUp : PhosphorIcons.dotsSixVertical,
        ...
        trailing: Row(
          ...
          children: [
            Container(
              ...
              child: IconButton(
                icon: AppIcon(isHidden ? PhosphorIcons.eyeSlash : PhosphorIcons.eye),
