...
class SideNavigationRailState extends State<SideNavigationRail> with MountedSetStateMixin {
                                ...
                                children: [
                                  ...
                                  if (!widget.isOfflineMode) ...[
                                    ...
                                    if (hasExplore) ...[
                                      _buildNavItem(
                                        ...
                                        selectedIcon: TablerIcons.compass,
                                    ...
                                    _buildNavItem(
                                      ...
                                      selectedIcon: TablerIcons.search,
                                  ...
                                  if (_showDownloads) ...[
                                    _buildNavItem(
                                      ...
                                      selectedIcon: TablerIcons.download,
                                  ...
                                  _buildNavItem(
                                    ...
                                    selectedIcon: TablerIcons.settings,
  ...
  Widget _buildReconnectItem({required bool isCollapsed}) {
    ...
    return NavigationRailItem(
      icon: widget.isReconnecting ? TablerIcons.refresh : TablerIcons.wifi,
      ...
      children: [
        NavigationRailItem(
          ...
          trailing: AnimatedOpacity(
            ...
            child: AppIcon(
              _librariesExpanded ? TablerIcons.chevronUp : TablerIcons.chevronDown,
              size: 20,
              color: t.textMuted,
            ),
          ),
