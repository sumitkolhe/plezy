...
class SideNavigationRailState extends State<SideNavigationRail> with MountedSetStateMixin {
                                ...
                                children: [
                                  ...
                                  if (!widget.isOfflineMode) ...[
                                    ...
                                    if (hasExplore) ...[
                                      _buildNavItem(
                                        ...
                                        selectedIcon: PhosphorIcons.compass,
                                  ...
                                  if (_showDownloads) ...[
                                    _buildNavItem(
                                      ...
                                      selectedIcon: PhosphorIcons.download,
  ...
  Widget _buildReconnectItem({required bool isCollapsed}) {
    ...
    return NavigationRailItem(
      icon: widget.isReconnecting ? PhosphorIcons.arrowsClockwise : PhosphorIcons.wifiHigh,
      ...
      children: [
        NavigationRailItem(
          ...
          trailing: AnimatedOpacity(
            ...
            child: AppIcon(
              _librariesExpanded ? PhosphorIcons.caretUp : PhosphorIcons.caretDown,
              size: 20,
              color: t.textMuted,
            ),
          ),
