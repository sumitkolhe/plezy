...
extension _PlayerControlsPlaybackInputMethods on _PlayerControlsState {
  ...
  void _onRateChanged(double newRate) {
    ...
    final icon = newRate >= 1.0 ? TablerIcons.playerTrackNext : TablerIcons.movie;
  ...
  void _seekToChapterWithFeedback({required bool forward}) {
    ...
    if (resolved.target != null) {
      ...
      widget.toastController.show(
        forward ? TablerIcons.playerSkipForward : TablerIcons.playerSkipBack,
  ...
  Widget _buildSpeedIndicator() => const PlayerToastIndicator(icon: TablerIcons.playerTrackNext, text: '2x');
}
