...
class _PlayerPerformanceOverlayState extends State<PlayerPerformanceOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = <Widget>[
      _buildSection(PhosphorIconsDuotone.videoCamera, t.fileInfo.video, [
      ...
      _buildSection(PhosphorIconsDuotone.speakerHigh, t.fileInfo.audio, [
      ...
      if (isMpv)
        _buildSection(PhosphorIconsDuotone.palette, t.performanceOverlay.color, [
      ...
      _buildSection(PhosphorIconsDuotone.gauge, t.performanceOverlay.performance, [
      ...
      if (_stats.hasHdrMetadata)
        _buildSection(PhosphorIconsDuotone.highDefinition, 'HDR', [
      ...
      _buildSection(PhosphorIconsDuotone.memory, t.performanceOverlay.buffer, [
      ...
      _buildSection(PhosphorIconsDuotone.squaresFour, t.performanceOverlay.app, [
