...
import 'package:harbor/mixins/tab_visibility_aware.dart';
...
import 'package:harbor/providers/discover_provider.dart';
...
import 'package:harbor/screens/discover_screen.dart';
...
void main() {
  ...
  testWidgets('non-TV hero keeps indicators visible in keyboard mode and fades to solid bg', (tester) async {
    ...
    expect(find.byIcon(TablerIcons.playerPause), findsOneWidget, reason: 'hero indicators render in pointer mode');
    ...
    await tester.pump();
    expect(
      find.byIcon(TablerIcons.playerPause),
      findsOneWidget,
