...
void main() {
  ...
  testWidgets('failed image placeholders keep explicit dimensions in loose layouts', (tester) async {
    ...
    expect(find.byIcon(PhosphorIconsFill.person), findsOneWidget);
  ...
  testWidgets('same local artwork path re-resolves after the file appears', (tester) async {
        ...
        home: StatefulBuilder(
          builder: (context, setState) {
            ...
            return OptimizedMediaImage.thumb(
              ...
              width: 80,
              height: 120,
              fallbackIcon: PhosphorIconsFill.imageBroken,
            );
          },
        ),
      ),
    ...
    expect(find.byIcon(PhosphorIconsFill.imageBroken), findsNothing);
    await tester.runAsync(() => Future<void>.delayed(Duration.zero));
    await tester.pump();
    expect(find.byIcon(PhosphorIconsFill.imageBroken), findsOneWidget);
